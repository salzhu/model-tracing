...
def main():
    model_1_id = "nvidia/Llama-3.1-Minitron-4B-Depth-Base" # "meta-llama/Llama-2-7b-hf" # "meta-llama/Llama-3.2-3B"
    model_2_id = "meta-llama/Llama-3.1-8B" # "princeton-nlp/Sheared-LLaMA-1.3B" #
