...
model_names_good = ["yahma/llama-7b-hf", "LLM360/Amber", "FinGPT/fingpt-forecaster_dow30_llama2-7b_lora", 
               "oh-yeontaek/llama-2-7B-LoRA-assemble", "lvkaokao/llama2-7b-hf-instruction-lora", "lmsys/vicuna-7b-v1.5", 
               "NousResearch/Nous-Hermes-llama-2-7b", "codellama/CodeLlama-7b-hf", "EleutherAI/llemma_7b"]

model_name = model_names_good[8]

print(model_name, flush=True)

model_ft = AutoModelForCausalLM.from_pretrained(model_name, torch_dtype=torch.bfloat16).to('cuda')
