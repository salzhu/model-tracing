...
from permutations_tests import permuted_mode_connectivity, save_permuted_mode_connectivity_results
...
filename = "/nlp/scr/salzhu/vicuna_llama_midpoint_onetext.csv"
plotpath = "temp"
...
for i in range(100):
    ...
    losses, perplexities = permuted_mode_connectivity(model_a, model_b, testset, alpha_step=0.5)
    print(losses[1])
